 ...
 */
export function generateChainlinkFunction(conditions, useAND) {
    return `
 ...
 */
export function validateAPIConditions(conditions) {
    const errors = [];
 ...
 */
export function generatePredicateId(conditions, useAND, maker) {
